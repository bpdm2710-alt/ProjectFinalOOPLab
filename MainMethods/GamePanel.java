...
<<<<<<< HEAD
        ...
        if (KeyHandler.restartPressed.get() && gameManager.getState() != GameState.GAME_OVER) {
            KeyHandler.restartPressed.set(false);
        }

        if (gameManager.getState() == GameState.GAME_OVER && KeyHandler.restartPressed.getAndSet(false)) {
=======
